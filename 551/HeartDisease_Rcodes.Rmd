...
### log loss
sum(-log(predtest1[ytest==1]))+sum(-log(1-predtest1[ytest==0]))
...
### log loss
sum(-log(prob2[ytest==1]))+sum(-log(1-prob2[ytest==0]))
### predictive sensitivity
...
### log loss
sum(-log(prob3[ytest==1]))+sum(-log(1-prob3[ytest==0]))
### predictive sensitivity
...
```{r}
# Compare Predictive Accuracy and plot
## png('accuracy.png')
plot(density(accuracy2_dist), main="Predictive Accuracy", xlab="predictive accuracy", col="red")
lines(density(accuracy3_dist), col="blue")
abline(v=accuracy1, col="black")
abline(v=accuracy2, col="red")
abline(v=accuracy3, col="blue")
legend(0.5, 6, c("Original","N-IG","N-E-G"), col=c("black","red","blue"), lty=c(1,1,1))
## dev.off()
```
