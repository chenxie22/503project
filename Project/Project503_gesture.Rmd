...
```
The accuracy of 84.63% indicates that KNN (K=3) also performed well on this dataset, although its performance was a little worse than the logistic regression with quadratic terms and QDA.
