...
### 3.1 Multinomial Logistic Regression with Quadratic Terms
...
From the confusion matrix of multinomial logistic regression in Table 3, we saw that adding quadratic terms in the logistic regression model greatly increased the prediction accuracy, from previous 34.5% to current 88.8%. This confirmed our expectation in data exploration that the decision boundary between classes was not linear. 
