...
The heatmap shows that X12-X17, i.e., amount of bill statement for each month from April to September, 2005 are higher correlated with each other. This supports the possibility to reduce the number of dimensions using PCA. 
